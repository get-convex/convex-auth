...
To define a custom schema, inline the the table definition from the library into
your schema:
...
[controlling account linking behavior](/advanced#controlling-account-linking-behavior).

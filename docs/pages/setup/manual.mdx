...
for you, follow these steps after you've installed the library.

For code changes you can also refer to the
[example repo](https://github.com/xixixao/convex-auth/blob/convex-auth-demo-src).
...
Continue to with [Step 3](/setup#add-authentication-tables-to-your-schema) in
the Setup guide.

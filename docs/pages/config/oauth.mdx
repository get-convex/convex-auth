...
React Native isn't supported yet.
...
Actions URL is `https://fast-horse-123.convex.site` and your callback URL for
GitHub is `https://fast-horse-123.convex.site/api/auth/callback/github`.

Don't forget that your Convex prod deployment will have a different name than
your dev deployment.

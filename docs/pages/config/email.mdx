...
Check out the
[example repo](https://github.com/get-convex/convex-auth-example/blob/main/app/auth/SignInFormEmailLink.tsx)
...
To make this kind of an attack less likely to succeed, you can add an interstial

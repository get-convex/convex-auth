...
<details>
  <summary>
    ...
    2. Click on your user avatar in the
    top-right of the page
    3. In the menu that opens, click **Settings**
    4. Scroll down
    and click **Developer settings** in the menu on the left
    5. Click **OAuth Apps**
...
value from the GitHub page and supply it as the last argument to the following

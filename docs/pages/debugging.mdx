...
You can enable structured error codes to see exactly what's failing during
authentication. Instead of generic errors, the library returns specific codes
like `INVALID_CREDENTIALS` or `RATE_LIMITED`. See

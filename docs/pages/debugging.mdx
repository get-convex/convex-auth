...
Structured error codes can help identify what's failing during authentication.
When configured, the library returns specific codes like `INVALID_CREDENTIALS`
or `RATE_LIMITED` instead of generic errors. See
[Error Handling](/error-handling) for the full list and configuration details.

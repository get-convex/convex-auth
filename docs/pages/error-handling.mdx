...
Convex Auth provides structured error codes for authentication failures,
allowing you to display specific feedback to users when sign-in attempts fail.

## Enabling structured errors
...
| `INVALID_CODE` | Wrong OTP / verification code |
| `EXPIRED_CODE` | Expired OTP / verification code |

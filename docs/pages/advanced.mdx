...
You can configure how authentication errors are handled via the `handleError`
callback, including returning structured error codes to the client. See the
dedicated [Error Handling](/error-handling) page for details.

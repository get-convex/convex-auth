...
| Parameter | Type |
| ------ | ------ |
| `config` | [`EmailUserConfig`](../server.mdx#emailuserconfigdatamodel)\<`DataModel`\> & `Pick`\<[`EmailConfig`](../server.mdx#emailconfigdatamodel)\<`GenericDataModel`\>, `"sendVerificationRequest"`\> |

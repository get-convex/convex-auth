...
| `args` | `object` | - |
| `args.provider` | `string` | The provider ID (like "password"), used to disambiguate accounts. It is also used to configure account secret hashing via the provider's `crypto` option. |
| `args.account` | `object` | - |
...
[src/server/implementation.ts:1390](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1390)
...
| `ctx` | `GenericActionCtx`\<`DataModel`\> | - |
| `args` | `object` | - |
| `args.provider` | `string` | The provider ID (like "password"), used to disambiguate accounts. It is also used to configure account secret hashing via the `crypto` option. |
| `args.account` | `object` | - |
| `args.account.id` | `string` | The unique external ID for the account, for example email address. |
...
[src/server/implementation.ts:1435](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1435)
...
[src/server/implementation.ts:1470](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1470)
...
[src/server/implementation.ts:1497](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1497)
...
<h3 class="nx-font-semibold nx-tracking-tight nx-text-slate-900 dark:nx-text-slate-100 nx-mt-8 nx-text-2xl">Extends</h3>
...
| `account` | [`GenericDoc`](server.mdx#genericdocdatamodel-tablename)\<`DataModel`, `"authAccounts"`\> | - |

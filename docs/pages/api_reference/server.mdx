...
[src/server/implementation.ts:284](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L284)
...
[src/server/implementation.ts:1359](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1359)
...
[src/server/implementation.ts:1424](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1424)
...
`Promise`\<[`GenericDoc`](server.mdx#genericdocdatamodel-tablename)\<`DataModel`, `"users"`\>\>

<h3 className="nx-font-semibold nx-tracking-tight nx-text-slate-900 dark:nx-text-slate-100 nx-mt-8 nx-text-2xl">Defined in</h3>

[src/server/implementation.ts:1469](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1469)
...
[src/server/implementation.ts:1504](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1504)
...
[src/server/implementation.ts:1531](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1531)
...
[src/server/types.ts:228](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L228)
...
[src/server/types.ts:252](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L252)
...
[src/server/types.ts:275](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L275)
...
[src/server/types.ts:312](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L312)
...
[src/server/types.ts:320](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L320)
...
[src/server/types.ts:340](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L340)
...
[src/server/types.ts:349](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L349)
...
[src/server/types.ts:368](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L368)

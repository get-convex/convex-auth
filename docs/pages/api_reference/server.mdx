...
|`type`|  `"email"` \| `"webauthn"` \| `"oidc"` \| `"oauth"` \| `"credentials"`
|`userId`|  `Id`\<`"users"`\>
|`provider`|  `string`
...
[src/server/implementation.ts:76](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L76)
...
[src/server/implementation.ts:277](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L277)
...
[src/server/implementation.ts:1023](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1023)
...
[src/server/implementation.ts:1070](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1070)
...
[src/server/implementation.ts:1111](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1111)
...
[src/server/implementation.ts:1146](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1146)
...
[src/server/implementation.ts:1181](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1181)
...
[src/server/implementation.ts:1204](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1204)

...
|Field|TS Type
|---|---
|`sessionId`|  `undefined` \| `Id`\<`"sessions"`\>
...
[src/server/implementation.ts:80](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L80)
...
| Parameter | Type |
| :------ | :------ |
| `config_` | [`ConvexAuthConfig`](server.mdx#convexauthconfigdatamodel)\<`DataModel`\> |
...
[src/server/implementation.ts:283](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L283)
...
[src/server/implementation.ts:1341](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1341)
...
[src/server/implementation.ts:1444](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1444)
...
[src/server/implementation.ts:1479](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1479)
...
[src/server/implementation.ts:1506](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1506)

***

## ConvexAuthConfig\<DataModel\>
...
[src/server/types.ts:180](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L180)
...
[src/server/types.ts:181](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L181)
...
[src/server/types.ts:189](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L189)
...
[src/server/types.ts:217](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L217)
...
[src/server/types.ts:218](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L218)
...
[src/server/types.ts:229](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L229)
...
See [ConvexAuthConfig](server.mdx#convexauthconfigdatamodel)

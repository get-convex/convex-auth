...
|`type`|  `"credentials"` \| `"email"` \| `"webauthn"` \| `"oidc"` \| `"oauth"`
|`userId`|  `Id`\<`"users"`\>
|`provider`|  `string`
...
[src/server/implementation.ts:79](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L79)
...
[src/server/implementation.ts:291](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L291)
...
[src/server/implementation.ts:1264](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1264)
...
[src/server/implementation.ts:1330](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1330)
...
[src/server/implementation.ts:1375](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1375)
...
[src/server/implementation.ts:1410](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1410)
...
[src/server/implementation.ts:1437](https://github.com/get-convex/convex-auth/blob/main/src/server/implementation.ts#L1437)
...
[src/server/types.ts:77](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L77)
...
[src/server/types.ts:94](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L94)
...
[src/server/types.ts:99](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L99)
...
[src/server/types.ts:103](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L103)
...
[src/server/types.ts:116](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L116)
...
[src/server/types.ts:125](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L125)
...
[src/server/types.ts:131](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L131)
...
[src/server/types.ts:138](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L138)
...
[src/server/types.ts:143](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L143)
...
[src/server/types.ts:152](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L152)
...
[src/server/types.ts:178](https://github.com/get-convex/convex-auth/blob/main/src/server/types.ts#L178)

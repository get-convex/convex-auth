 ...
 *
 * Returns the shared sign-in envelope: the session token bundle, or an
 * `INVALID_CODE` error when the code is unknown, already redeemed, expired, or
 * the state doesn't match: all indistinguishable to the caller.
 *

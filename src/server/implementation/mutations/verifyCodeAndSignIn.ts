...
type ReturnType = { error: AuthErrorCode } | SessionInfo;
...
async function verifyCodeOnly(
  ...
  if (account === null) {
    ...
    return { error: AuthErrorCode.ACCOUNT_DELETED };
  }
  if (
    ...
    return { error: AuthErrorCode.PROVIDER_MISMATCH };
  }

...
// `upsertFromAuth` whenever a brand-new account signs in; this example owns no
// users table and just echoes the account id back as the app user id.
const core = setupCore({
  component: components.core,
  createUser: internal.users.upsertFromAuth,
});
